...
STATIC const mp_rom_map_elem_t xblepy_constants_charac_prop_locals_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_PROP_WRITE_NO_RESP),  MP_ROM_INT(XBLEPY_PROP_WRITE_NO_RESP) },
...
STATIC const mp_rom_map_elem_t xblepy_constants_attr_perm_locals_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_PERM_READ_FREE),              MP_ROM_INT(XBLEPY_PERM_READ_FREE) },
    ...
    { MP_ROM_QSTR(MP_QSTR_PERM_WRITE_FREE),             MP_ROM_INT(XBLEPY_PERM_WRITE_FREE) },
