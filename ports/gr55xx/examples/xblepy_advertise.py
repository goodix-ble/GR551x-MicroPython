...
import ble,xblepy
ble.enable()
s1 = xblepy.Service(xblepy.UUID("6e400001-b5a3-f393-e0a9-e50e24dcca98"))
c1 = xblepy.Characteristic(xblepy.UUID("6e400002-b5a3-f393-e0a9-e50e24dcca98"))
c2 = xblepy.Characteristic(xblepy.UUID("6e400004-b5a3-f393-e0a9-e50e24dcca98"))
d1 = xblepy.Descriptor(xblepy.UUID("6e400003-b5a3-f393-e0a9-e50e24dcca98"))
d2 = xblepy.Descriptor(xblepy.UUID(0x2902))
d3 = xblepy.Descriptor(xblepy.UUID(0x2902))
c1.addDescriptor(d1)
c1.addDescriptor(d2)
c2.addDescriptor(d3)
